...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.courses.modules', $lesson->module->digitalProduct->id) }}">{{ $lesson->module->digitalProduct->title }}</a>
                    </li>
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.modules.lessons', $lesson->module->id) }}">{{ $lesson->module->title }}</a>
                    </li>
        ...
        <div>
            <a href="{{ route('admin.modules.lessons', $lesson->module->id) }}" class="btn btn-outline-secondary">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.lessons.update', $lesson->id) }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('content_type') is-invalid @enderror" 
                                        ...
                                        <option value="text" {{ old('content_type', $lesson->content_type) == 'text' ? 'selected' : '' }}>Texto</option>
                                        <option value="video" {{ old('content_type', $lesson->content_type) == 'video' ? 'selected' : '' }}>Vídeo</option>
                                        <option value="iframe" {{ old('content_type', $lesson->content_type) == 'iframe' ? 'selected' : '' }}>Iframe/Embed</option>
                                        <option value="file" {{ old('content_type', $lesson->content_type) == 'file' ? 'selected' : '' }}>Arquivo para Download</option>
                                    </select>
                                    @error('content_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('duration_minutes') is-invalid @enderror" 
                                           id="duration_minutes" name="duration_minutes" value="{{ old('duration_minutes', $lesson->duration_minutes) }}" min="0" required>
                            ...
                            <div id="video-fields" class="content-field" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control @error('content_url') is-invalid @enderror" 
                                           id="content_url" name="content_url" value="{{ old('content_url', $lesson->content_url) }}" 
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('admin.modules.lessons', $lesson->module->id) }}" class="btn btn-secondary">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <span class="badge bg-{{ $lesson->content_type === 'video' ? 'danger' : ($lesson->content_type === 'iframe' ? 'info' : 'secondary') }}">
